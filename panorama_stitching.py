...
def genMatrix(im_x,im_y):
    ...
    """
    i_x_blurred = utils.blur_spatial(im_x * im_x, 3)
    i_y_blurred = utils.blur_spatial(im_y*im_y, 3)
    i_yx_blurred = utils.blur_spatial(im_x*im_y, 3)
...
def harris_corner_detector(im):
    ...
    # Step 2: Blur the images: Ix2 , Iy2 , IxIy. You may use blur_spatial function from utils.py with kernel_size=3.
    m = genMatrix(i_x, i_y)
